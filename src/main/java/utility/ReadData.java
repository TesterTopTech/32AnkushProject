...
public class ReadData extends TestBase
{
	public static String readPropertyFile(String value) throws IOException
	{
		...
		FileInputStream file=new FileInputStream("C:\\Users\\Lenovo\\eclipse-workspace\\Framework_Batch32\\Test Data\\config.properties");
		prop.load(file);
		return prop.getProperty(value);
	}
	public static String readExcel(int rowNum,int colNum) throws EncryptedDocumentException, IOException
	{
		FileInputStream file=new FileInputStream("C:\\Users\\Lenovo\\eclipse-workspace\\Framework_Batch32\\Test Data\\Book1.xlsx");
