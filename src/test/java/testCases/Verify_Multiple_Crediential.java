...
public class Verify_Multiple_Crediential extends TestBase
{
	...
	public void logintoApplicationWithMultipleCredsTest(String un,String pas)
	{
		SoftAssert s=new SoftAssert();
		String expURL="https://www.saucedemo.com/inventory.html";
		String actURL=login.logintoApplicationWithMultipleCreds(un, pas);
